...
try{
  ...
  ok('clean long-form drafts skip the redundant full rewrite while deterministic findings still use targeted repair',/editorialDuration>240/.test(result.editorSource)&&/Final story checks passed/.test(result.editorSource)&&/targetedFallback/.test(result.editorSource),result.editorSource);
