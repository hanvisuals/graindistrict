...
try{
  ...
  const result=await page.evaluate(()=>{
    ...
    return {issues,resolvedIssues,unclearIssues:window.gdNarrativeEditorialIssues(unclearOpening,plan),povIssues:window.gdNarrativeEditorialIssues(povDrift,plan),repeatIssues:window.gdNarrativeEditorialIssues(repeatedDiscovery,plan),investigationIssues:window.gdNarrativeEditorialIssues(investigationScript,investigationPlan),directionPrompt:creativeContractPrompt(),planPrompt:window.gdNarrativePlanPrompt(360,'')};
  });
